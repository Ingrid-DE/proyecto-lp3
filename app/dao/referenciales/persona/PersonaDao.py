...
class PersonaDao:
    ...
    def getPersonas(self):
        ...
        try:
            ...
            app.logger.info(f"Error al obtener todas las personas: {str(e)}")
            return []
    ...
    def guardarPersona(self, descripcion, apellido, cedula):
        ...
        insertPersonaSQL = """
   INSERT INTO personas(descripcion, apellido, cedula) VALUES(%s, %s, %s) RETURNING id        
   """
    ...
    def updatePersona(self, id, descripcion, apellido, cedula):
        updatePersonaSQL = """
        UPDATE personas
        SET descripcion=%s, apellido=%s, cedula=%s
        WHERE id=%s
        """
