...
def addAgenda_medica():
    ...
    campos_requeridos = ['hora_inicio', 'hora_fin']
    ...
    try:
        ...
        agenda_medica_id = agendamedicadao.guardarAgenda_medica(hora_inicio, hora_fin)
        if agenda_medica_id is not None:
            return jsonify({
                'success': True,
                'data': {'id_agenda_medica': agenda_medica_id, 'hora_inicio': hora_inicio, 'hora_fin': hora_fin},
                'error': None
            }), 201
        else:
...
def updateAgenda_medica(agenda_medica_id):
    ...
    hora_fin = data['hora_fin']
    try:
        if agendamedicadao.updateAgenda_medica(agenda_medica_id, hora_inicio, hora_fin):
            return jsonify({
                'success': True,
                'data': {'id_agenda_medica': agenda_medica_id, 'hora_inicio': hora_inicio, 'hora_fin': hora_fin},
                'error': None
